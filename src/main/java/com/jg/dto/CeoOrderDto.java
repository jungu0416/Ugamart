...
public class CeoOrderDto {
	...
	public CeoOrderDto() {}
	public CeoOrderDto(String order_number, String customer_id, String product_number_amount, String ceo_number,
	...
	public String toString() {
		return "CeoOrderDto [order_number=" + order_number + ", customer_id=" + customer_id + ", product_number_amount="
				+ product_number_amount + ", ceo_number=" + ceo_number + ", order_date=" + order_date + ", total_price="
				+ total_price + ", required_address=" + required_address + ", delivery_whether=" + delivery_whether
				+ "]";
	}
