...
public class CustomerEachOrderDto {
	...
	public CustomerEachOrderDto() {}
	public CustomerEachOrderDto(String order_number, String customer_id, String product_number, String amount,
			String price, String order_date, String required_address, String delivery_whether, String product_k_name,
			String ceo_number) {
		super();
	...
	public String toString() {
		return "CustomerEachOrderDto [order_number=" + order_number + ", customer_id=" + customer_id
				+ ", product_number=" + product_number + ", amount=" + amount + ", price=" + price + ", order_date="
				+ order_date + ", required_address=" + required_address + ", delivery_whether=" + delivery_whether
				+ ", product_k_name=" + product_k_name + ", ceo_number=" + ceo_number + "]";
	}
