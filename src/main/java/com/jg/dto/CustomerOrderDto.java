...
public class CustomerOrderDto {
	...
	public CustomerOrderDto(String order_number, String customer_id, String product_number_amount, String ceo_number,
	...
	public String toString() {
		return "CustomerOrderDto [order_number=" + order_number + ", customer_id=" + customer_id
