...
public class CustomerReviewDto {
	...
	public CustomerReviewDto(String customer_id, String order_number, String product_number, String ceo_number,
			String customer_title, String customer_content, String rating, String review_date, String ceo_reply,
			String product_k_name) {
		super();
	...
	public String toString() {
		return "CustomerReviewDto [customer_id=" + customer_id + ", order_number=" + order_number + ", product_number="
				...
				+ ", ceo_reply=" + ceo_reply + ", product_k_name=" + product_k_name + "]";
	}
