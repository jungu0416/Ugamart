...
public class CustomerStoreDto {
	...
	public CustomerStoreDto(String ceo_store_name, String ceo_number, String product_number, String product_category,
			String product_k_name, String product_price, String product_rating, String product_stock,
			String product_detail, String product_date) {
		super();
	...
	public String toString() {
		return "CustomerStoreList [ceo_store_name=" + ceo_store_name + ", ceo_number=" + ceo_number
