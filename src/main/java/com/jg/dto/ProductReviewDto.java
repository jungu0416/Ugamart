...
public class ProductReviewDto {
	...
	public ProductReviewDto(String customer_id, String order_number, String product_number, String ceo_number,
	...
	public String toString() {
		return "ProductReviewDto [customer_id=" + customer_id + ", order_number=" + order_number + ", product_number="
