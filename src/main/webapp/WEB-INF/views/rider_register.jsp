...
<body>
	...
	<h1 class="rider-title">회원가입</h1>
		<form action="riderRegisterAction" method='post'>
			<div class="riderinput-info">
				...
				<div onclick="sample4_execDaumPostcode()" id="btn-address">우편번호 찾기</div>
			...
			<div style="text-align:center;"><input type='submit' value='회원가입' class="riderRegister"/></div>
		</form>
	</div>
</body>
</html>